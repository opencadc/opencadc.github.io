...
## Connection pool for UWS schema in si_db database
...
org.opencadc.luskan.uws.url=jdbc:postgresql://yourdbhost:5432/si_db

## Connection pool for TAP schema in si_db database
...
org.opencadc.luskan.tapadm.url=jdbc:postgresql://yourdbhost:5432/si_db

## Connection pool for running tap queries in inventory schema in si_db
...
org.opencadc.luskan.query.url=jdbc:postgresql://yourdbhost:5432/si_db
